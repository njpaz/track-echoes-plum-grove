  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="flex items-cemter justify-center bg-zinc-50 dark:bg-gray-800">
          <main className="flex main w-full max-w-5xl flex-col items-start justify-start py-4">
            {children}
          </main>
        </div>
